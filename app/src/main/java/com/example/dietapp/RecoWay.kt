...
class RecoWay : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        video1 = findViewById(R.id.reco_image1)
        video2 = findViewById(R.id.reco_image2)
        video3 = findViewById(R.id.reco_image3)
        text1 = findViewById(R.id.reco_text2)
        text2 = findViewById(R.id.reco_text4)
